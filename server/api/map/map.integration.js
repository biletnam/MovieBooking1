...
describe('Map API:', function() {
  ...
  describe('GET /api/maps', function() {
    ...
    it('should respond with JSON array', function() {
      expect(maps).to.be.instanceOf(Array);
    });
  ...
  describe('POST /api/maps', function() {
    ...
    it('should respond with the newly created map', function() {
      expect(newMap.name).to.equal('New Map');
      expect(newMap.info).to.equal('This is the brand new map!!!');
    });
  ...
  describe('GET /api/maps/:id', function() {
    ...
    it('should respond with the requested map', function() {
      expect(map.name).to.equal('New Map');
      expect(map.info).to.equal('This is the brand new map!!!');
    });
  ...
  describe('PUT /api/maps/:id', function() {
    ...
    it('should respond with the updated map', function() {
      expect(updatedMap.name).to.equal('Updated Map');
      expect(updatedMap.info).to.equal('This is the updated map!!!');
    });
